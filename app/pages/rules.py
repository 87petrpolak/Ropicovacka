...
|---------|--------|------|
| Gól | Všichni | **30** |
| Asistence | Všichni | **25** |
| Výhra týmu | Záložník, Obránce | **15** |
| Čisté konto | Brankář | **30** |
| Čisté konto | Obránce | **15** |

> Čisté konto = tým nedostal žádný gól v daném zápase (počítá se stav ve chvíli, kdy hráč opouštěl hřiště).
> Záložníci a útočníci za čisté konto body **nedostávají**.
> Útočníci a brankáři za výhru týmu body **nedostávají**.
> Bonusy za výhru a čisté konto platí jen při odehrání **60+ minut**.
